        ...
        return try {
            ...
            if (src.isDirectory) {
                ...
                if (existing != null) {
                    val existingUri =
                        DocumentsContract.buildDocumentUriUsingTree(treeUri, existing.docId)
                    val bakName = destName + ".ziparc-bak"
                ...
                val tempName = destName + ".ziparc-part"
        ...
        return try {
            ...
            if (mime == DocumentsContract.Document.MIME_TYPE_DIR) {
                ...
                val part = if (parent != null) {
                    File(parent, dst.name + ".ziparc-part")
                } else {
                    File(dst.path + ".ziparc-part")
                }
                ...
                try {
                    val bak = if (dst.exists()) File(dst.parentFile, dst.name + ".ziparc-bak") else null
                    if (bak != null) {

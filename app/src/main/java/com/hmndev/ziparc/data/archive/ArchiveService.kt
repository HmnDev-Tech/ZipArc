package com.hmndev.ziparc.data.archive
...
import com.hmndev.ziparc.MainActivity
import com.hmndev.ziparc.R
...
class ArchiveService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.hmndev.ziparc.data.archive.ArchiveService.ACTION_START"
        const val ACTION_CANCEL = "com.hmndev.ziparc.data.archive.ArchiveService.ACTION_CANCEL"
    ...
    private fun acquireWakeLock() {
        ...
        try {
            ...
            val lock = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "ziparc:archive-op")
